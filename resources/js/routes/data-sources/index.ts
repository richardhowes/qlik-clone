...
/**
* @see \App\Http\Controllers\DataSourceController::configFields
* @see app/Http/Controllers/DataSourceController.php:168
* @route '/data-source-config-fields'
*/
export const configFields = (options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'get',
} => ({
    url: configFields.url(options),
    method: 'get',
})

configFields.definition = {
    methods: ['get','head'],
...
* @route '/data-source-config-fields'
*/
configFields.url = (options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    return configFields.definition.url + queryParams(options)
}
...
* @route '/data-source-config-fields'
*/
configFields.get = (options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'get',
} => ({
    url: configFields.url(options),
...
* @route '/data-source-config-fields'
*/
configFields.head = (options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'head',
} => ({
    url: configFields.url(options),
